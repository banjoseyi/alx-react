...
describe('checking for menu and button calls', () => {
  ...
  it('check button calls on click', () => {
    const handleDisplayDrawer = jest.fn();
    const handleHideDrawer = jest.fn();
    const check = shallow(
      <Notifications displayDrawer handleDisplayDrawer={handleDisplayDrawer} handleHideDrawer={handleHideDrawer} />
    );
    check.find('#closeButton').simulate('click');
